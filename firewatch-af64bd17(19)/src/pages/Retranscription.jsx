...
export default function RetranscriptionPage() {
  ...
  useEffect(() => {
    ...
    loadDailySummaries();
  }, [selectedFilter, deputes, detectSpeakersFromHTML]); // Dependencies update to include detectSpeakersFromHTML
                         ...
                         {selectedFilter === FILTERS.QUESTIONS_QUEBEC ? (
                           ...
                           <div className="prose prose-slate max-w-none" style={{ minHeight: '400px' }}>
                             ...
                             <PdQContentEditor
                               ...
                               onSpeakerChange={handleSpeakerChangeOttawa} // Ottawa specific speaker change handler
