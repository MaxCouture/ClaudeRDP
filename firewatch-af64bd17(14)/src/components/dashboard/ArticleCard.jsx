          ...
          <CardHeader className={isCompact ? 'pb-3 pt-3 px-4' : 'pb-4 px-5'}>
            <div className="flex items-start justify-between gap-3 min-w-0">
              <div className="flex-1 space-y-2 min-w-0">
                ...
                {!isCompact && (
                  <>
                    {/* CORRECTION: Informations sources simplifiées */}
                    ...
                    {/* SUPPRESSION: Retrait complet de l'indicateur Presse Canadienne */}
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {/* NOUVEAU: Badge de qualité */}
                   {article.quality_grade && (
                    <Badge className={`${GRADE_COLORS[article.quality_grade] || 'bg-gray-200'} font-medium text-xs`}>
                      Note: {article.quality_grade}
                    </Badge>
                  )}
